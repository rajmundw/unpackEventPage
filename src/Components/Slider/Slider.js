                ...
                <div className='row'>
                    <div className="col-8 offset-2 pl-0 pr-0">
                        <div className='slide-1 col-12 '>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus atque commodi dolores ducimus ipsam libero magnam, modi nam repellat temporibus.</p>
                        </div>
                        <div className='col-12 slide-2'>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur ipsum non saepe totam? Atque consequatur dolorum, modi mollitia veniam voluptatibus.</p>
                        </div>
                    </div>
                </div>
                <div className="row">
